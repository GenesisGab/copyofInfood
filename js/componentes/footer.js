    ...
    '<div class="padreFooter" data-aos="fade-up" data-aos-duration="1000">'+
        ...
        '<img  class="ventana_img" src="./img/alimentos.png">'+
            ...
            '<p class="ventana_parrafo">Lorem lpsum is simply dummy text of the printing and typesetting industry. Lorem lpsum'+
                'has been the industry´s standard  dummy text ever since  the 1500s, when an un unknown printer'+
                'took'+
            '</p>'+
        '</div>'+
        ...
        '<div class="ventana_titulo3">'+
            '<h2>Lorem lpsum</h2>'+
            '<p>lorem ipsu8m is simply dummy text of the printing and typesetting industry. Lorem lpsum has been the industry´s strandard dummy txtever since the 150s. when an unknownprinter took. Lorem ipsum is simply dummy text of the printing and typesetting industry , Lorem lpsum'+
        'has been the industry´s standard dummy text ever since the 1500s, when on unknown pinter look Lorem lpsum is simply dummy text of the printing abd typesetting industry . Lorem lpsum has been the industry´s standard dummy text ever since the 1500s, when an unknawn printer took. Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>'+
        '</div>'+
    '</div>'+
'</section>';
}
